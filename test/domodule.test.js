...
describe("actions", () => {
  ...
  test("Should have processed = true", () => {
    ...
    expect(
      instance.findByName("test0").dataset.domoduleActionProcessed
    ).toMatch("true");
  });
});
...
describe("action on module", () => {
  ...
  test("Should have processed = true", () => {
    expect(
      document.getElementById("ExampleModule").dataset.domoduleActionProcessed
    ).toMatch("true");
  });
});
...
describe("refs and getInstance", () => {
  ...
  test("getInstance returns module instance", () => {
    expect(
      Domodule.getInstance(document.getElementById("ExampleModule")) instanceof
        Domodule
    ).toBeTruthy();
  });
});
...
describe("named", () => {
  ...
  test("Should have processed = true", () => {
    expect(instance.findByName("tester").dataset.domoduleNameProcessed).toMatch(
      "true"
    );
  });
});
...
describe("required action", () => {
  ...
  test("Should throw if required action is missing", () => {
    ...
    `;
    expect(() => Domodule.discover()).toThrow(
      /testMouseOver is required as actions for Example, but is missing!/
    );
  });
});
...
describe("required named", () => {
  ...
  test("Should throw if required named is missing", () => {
    ...
    `;
    expect(() => Domodule.discover()).toThrow(
      /tester is required as named for Example, but is missing!/
    );
  });
});
...
describe("required option", () => {
  ...
  test("Should throw if required option is missing", () => {
    ...
    `;
    expect(() => Domodule.discover()).toThrow(
      /important is required as options for Example, but is missing!/
    );
  });
});
...
describe("nested modules", () => {
  ...
  test("Nested action not processed", () => {
    expect(
      instance.find('[data-action="nestedAction"]')[0].dataset
        .domoduleActionProcessed
    ).toBeFalsy();
  });
});
